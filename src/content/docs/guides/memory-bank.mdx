...
| `01-` | Active state | Every session start |
| `02-` | Architecture | Touching system design |
| `03-` | Patterns | Implementing something similar |
| `04+` | Reference material | As needed |

## Key files

### 00-core/projectBrief.md
...
<Aside type="caution">
  Always read projectBrief.md before proposing architectural changes. It establishes the project's identity.
</Aside>
...
| `00-core/` | identity.md, systems.md | projectBrief.md, productContext.md |
